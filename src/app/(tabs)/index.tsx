    ...
    return (
        <ParallaxScrollView
            ...
            <Link href='/(authorization)'>
                <ThemedText>Authorization</ThemedText>
            </Link>
            ...
            <ThemedView style={styles.stepContainer}>
                <ThemedText type="subtitle">Step 4: Qotaqyn {count} cm</ThemedText>
                <Button title={"Qotaqtyn basy"} onPress={() => dispatch(increment())} />
                <Button title={"Qotaqtyn arty"} onPress={() => dispatch(decrement())} />
            </ThemedView>
        </ParallaxScrollView>
    );
}
