...
interface CoachAddScheduleModalProps {
    modalVisible:boolean,
    setModalVisible: (visible: Boolean) => void,
}

const CoachAddScheduleModal:React.FC<CoachAddScheduleModalProps> = ({modalVisible, setModalVisible}) => {
                ...
                {({values, errors, touched, handleChange, handleSubmit}) => (
                    <View>
                        <View style={{flexDirection:'row', marginBottom:scale(25), alignItems:'center'}}>
                            ...
                            <Text style={[styles.mainTitle, {color:textColor}]}>Добавить тренера</Text>
                        </View>
...
export default CoachAddScheduleModal
