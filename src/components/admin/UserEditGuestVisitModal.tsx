...
interface UserEditGuestVisitModalProps {
    name:string,
    phoneNumber:string,
    data:string,
...
const UserEditGuestVisitModal:React.FC<UserEditGuestVisitModalProps> = ({ name, phoneNumber, data, modalVisible, setModalVisible }) => {
...
export default UserEditGuestVisitModal
